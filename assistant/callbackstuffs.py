...
_buttons = {
    ...
    "oofdm": {
        "text": "About [Dual Mode](https://t.me/OreoUpdates/16)",
        "buttons": [
            [
...
async def _(e):
    if not e.is_private:
        return
    await e.edit(
        "Click Authorise and send the code.\n\nYou can use your own CLIENT ID and SECRET by [this](https://t.me/OreoUpdates/35)",
        buttons=[
            [
